 ...
 */
public class Res1ThirdFragment extends Fragment implements View.OnClickListener {
    ...
    Button tvSwitch;
    RadioGroup rgOhm;
    ImageView img_show, img_show2, img_show3, img_show4, img_show5, img_show6;
    Button btn1black, btn1brown, btn1red, btn1orange, btn1yellow, btn1green, btn1blue, btn1violet, btn1gray, btn1white,
            ...
            btn6brown, btn6red, btn6orange, btn6yellow;
    int num_bar_1 = 0;
    int num_bar_2 = 0;
    int num_bar_3 = 0;
    int num_bar_4 = 0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_res1_third, container, false);
    ...
    private void initInstances(View rootView) {
        ...
        img_show6 = (ImageView) rootView.findViewById(R.id.img_show6);
        ...
        tv_result4 = (TextView) rootView.findViewById(R.id.tv_result4);
        ...
        btn6brown = (Button) rootView.findViewById(R.id.btn6brown);
        btn6red = (Button) rootView.findViewById(R.id.btn6red);
        btn6orange = (Button) rootView.findViewById(R.id.btn6orange);
        btn6yellow = (Button) rootView.findViewById(R.id.btn6yellow);
        ...
        btn6brown.setOnClickListener(this);
        btn6red.setOnClickListener(this);
        btn6orange.setOnClickListener(this);
        btn6yellow.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn1black:
                img_show.setImageResource(R.drawable.r6_c1_black);
                num_bar_1 = 00;
                break;
            case R.id.btn1brown:
                img_show.setImageResource(R.drawable.r6_c1_brown);
                num_bar_1 = 100;
                break;
            case R.id.btn1red:
                img_show.setImageResource(R.drawable.r6_c1_red);
                num_bar_1 = 200;
                break;
            case R.id.btn1orange:
                img_show.setImageResource(R.drawable.r6_c1_orange);
                num_bar_1 = 300;
                break;
            case R.id.btn1yellow:
                img_show.setImageResource(R.drawable.r6_c1_yellow);
                num_bar_1 = 400;
                break;
            case R.id.btn1green:
                img_show.setImageResource(R.drawable.r6_c1_green);
                num_bar_1 = 500;
                break;
            case R.id.btn1blue:
                img_show.setImageResource(R.drawable.r6_c1_blue);
                num_bar_1 = 600;
                break;
            case R.id.btn1violet:
                img_show.setImageResource(R.drawable.r6_c1_violet);
                num_bar_1 = 700;
                break;
            case R.id.btn1gray:
                img_show.setImageResource(R.drawable.r6_c1_gray);
                num_bar_1 = 800;
                break;
            case R.id.btn1white:
                img_show.setImageResource(R.drawable.r6_c1_white);
                num_bar_1 = 900;
                break;
        }
        switch (v.getId()) {
            case R.id.btn2black:
                img_show2.setImageResource(R.drawable.r6_c2_black);
                num_bar_2 = 0;
                break;
            case R.id.btn2brown:
                img_show2.setImageResource(R.drawable.r6_c2_brown);
                num_bar_2 = 10;
                break;
            case R.id.btn2red:
                img_show2.setImageResource(R.drawable.r6_c2_red);
                num_bar_2 = 20;
                break;
            case R.id.btn2orange:
                img_show2.setImageResource(R.drawable.r6_c2_orange);
                num_bar_2 = 30;
                break;
            case R.id.btn2yellow:
                img_show2.setImageResource(R.drawable.r6_c2_yellow);
                num_bar_2 = 40;
                break;
            case R.id.btn2green:
                img_show2.setImageResource(R.drawable.r6_c2_green);
                num_bar_2 = 50;
                break;
            case R.id.btn2blue:
                img_show2.setImageResource(R.drawable.r6_c2_blue);
                num_bar_2 = 60;
                break;
            case R.id.btn2violet:
                img_show2.setImageResource(R.drawable.r6_c2_violet);
                num_bar_2 = 70;
                break;
            case R.id.btn2gray:
                img_show2.setImageResource(R.drawable.r6_c2_gray);
                num_bar_2 = 80;
                break;
            case R.id.btn2white:
                img_show2.setImageResource(R.drawable.r6_c2_white);
                num_bar_2 = 90;
                break;
        }
        switch (v.getId()) {
            case R.id.btn3black:
                img_show3.setImageResource(R.drawable.r6_c3_black);
                num_bar_3 = 0;
                break;
            case R.id.btn3brown:
                img_show3.setImageResource(R.drawable.r6_c3_brown);
                num_bar_3 = 1;
                break;
            case R.id.btn3red:
                img_show3.setImageResource(R.drawable.r6_c3_red);
                num_bar_3 = 2;
                break;
            case R.id.btn3orange:
                img_show3.setImageResource(R.drawable.r6_c3_orange);
                num_bar_3 = 3;
                break;
            case R.id.btn3yellow:
                img_show3.setImageResource(R.drawable.r6_c3_yellow);
                num_bar_3 = 4;
                break;
            case R.id.btn3green:
                img_show3.setImageResource(R.drawable.r6_c3_green);
                num_bar_3 = 5;
                break;
            case R.id.btn3blue:
                img_show3.setImageResource(R.drawable.r6_c3_blue);
                num_bar_3 = 6;
                break;
            case R.id.btn3violet:
                img_show3.setImageResource(R.drawable.r6_c3_violet);
                num_bar_3 = 7;
                break;
            case R.id.btn3gray:
                img_show3.setImageResource(R.drawable.r6_c3_gray);
                num_bar_3 = 8;
                break;
            case R.id.btn3white:
                img_show3.setImageResource(R.drawable.r6_c3_white);
                num_bar_3 = 9;
                break;
        }
        ...
        switch (v.getId()) {
            case R.id.btn4black:
                img_show4.setImageResource(R.drawable.r6_c4_black);
                num_bar_4 = 1;
                num_bar_4_1 = 1;
                tv_result2_power.setText("");
                break;
            case R.id.btn4brown:
                img_show4.setImageResource(R.drawable.r6_c4_brown);
                num_bar_4 = 10;
                num_bar_4_1 = 10;
                tv_result2_power.setText("");
                break;
            case R.id.btn4red:
                img_show4.setImageResource(R.drawable.r6_c4_red);
                num_bar_4 = 10;
                num_bar_4_1 = 100;
                num_bar_4_2 = 2;
            ...
            case R.id.btn4orange:
                img_show4.setImageResource(R.drawable.r6_c4_orange);
                num_bar_4 = 10;
                num_bar_4_1 = 1000;
                num_bar_4_2 = 3;
            ...
            case R.id.btn4yellow:
                img_show4.setImageResource(R.drawable.r6_c4_yellow);
                num_bar_4 = 10;
                num_bar_4_1 = 10000;
                num_bar_4_2 = 4;
                ...
                break;
            case R.id.btn4green:
                img_show4.setImageResource(R.drawable.r6_c4_green);
                num_bar_4 = 10;
                num_bar_4_1 = 100000;
                num_bar_4_2 = 5;
                ...
                break;
            case R.id.btn4blue:
                img_show4.setImageResource(R.drawable.r6_c4_blue);
                num_bar_4 = 10;
                num_bar_4_1 = 1000000;
                num_bar_4_2 = 6;
            ...
            case R.id.btn4violet:
                img_show4.setImageResource(R.drawable.r6_c4_violet);
                num_bar_4 = 10;
            ...
            case R.id.btn4silver:
                img_show4.setImageResource(R.drawable.r6_c4_silver);
                num_bar_4 = 10;
                num_bar_4_1 = 0.1;
                num_bar_4_2 = -1;
                ...
                break;
            case R.id.btn4gold:
                img_show4.setImageResource(R.drawable.r6_c4_gold);
                num_bar_4 = 10;
                num_bar_4_1 = 0.01;
                num_bar_4_2 = -2;
                tv_result2_power.setText("-2");
        ...
        switch (v.getId()) {
            ...
            case R.id.btn5brown:
                img_show5.setImageResource(R.drawable.r6_c5_brown);
                tv_result3.setText(R.string.error_1_percent);
                break;
            case R.id.btn5red:
                img_show5.setImageResource(R.drawable.r6_c5_red);
                tv_result3.setText(R.string.error_2_percent);
                break;
            case R.id.btn5silver:
                img_show5.setImageResource(R.drawable.r6_c5_silver);
                tv_result3.setText(R.string.error_10_percent);
                break;
            case R.id.btn5gold:
                img_show5.setImageResource(R.drawable.r6_c5_gold);
                tv_result3.setText(R.string.error_5_percent);
                break;
            case R.id.btn5green:
                img_show5.setImageResource(R.drawable.r6_c5_green);
                tv_result3.setText(R.string.error_05_percent);
                break;
            case R.id.btn5blue:
                img_show5.setImageResource(R.drawable.r6_c5_blue);
                tv_result3.setText(R.string.error_025_percent);
                break;
            case R.id.btn5violet:
                img_show5.setImageResource(R.drawable.r6_c5_violet);
        ...
        switch (v.getId()) {
            ...
            case R.id.btn6brown:
                img_show6.setImageResource(R.drawable.r6_c6_brown);
                tv_result4.setText(R.string.ppm100);
                break;
            case R.id.btn6red:
                img_show6.setImageResource(R.drawable.r6_c6_red);
                tv_result4.setText(R.string.ppm50);
                break;
            case R.id.btn6orange:
                img_show6.setImageResource(R.drawable.r6_c6_orange);
                tv_result4.setText(R.string.ppm15);
                break;
            case R.id.btn6yellow:
                img_show6.setImageResource(R.drawable.r6_c6_yellow);
                tv_result4.setText(R.string.ppm25);
                break;
        }
